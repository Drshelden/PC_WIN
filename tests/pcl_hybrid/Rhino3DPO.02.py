...
class PCLProcessorSettingsForm(EtoForms.Dialog[bool]):
    ...
    def __init__(self):
        ...
        # legacy CGAL shape param dicts (tabs removed) - keep empty for compatibility
        self.plane_params = {}
    ...
    def CreateGeneralTab(self):
        ...
        cluster_tolerance_label = EtoForms.Label(Text="Cluster Tolerance:")
        ...
        min_cluster_size_label = EtoForms.Label(Text="Min Cluster Size:")
        ...
        max_cluster_size_label = EtoForms.Label(Text="Max Cluster Size:")
        ...
        max_shapes_label = EtoForms.Label(Text="Max Shapes per Cluster:")
        ...
        min_points_threshold_label = EtoForms.Label(Text="Min Points Threshold:")
        shape_layout.AddRow(min_points_threshold_label, self.min_points_threshold_box)

        shape_group.Content = shape_layout

        # Add info panel
        info_label = EtoForms.Label(Text="General parameters that affect clustering and overall shape detection behavior.")
    ...
    def CreateShapeTab(self, shape_name, params_dict, prefix):
        ...
        min_points_label = EtoForms.Label(Text="Min Points:")
        ...
        epsilon_label = EtoForms.Label(Text="Epsilon (Distance Tolerance):")
        ...
        cluster_epsilon_label = EtoForms.Label(Text="Cluster Epsilon:")
        ...
        normal_threshold_label = EtoForms.Label(Text="Normal Threshold:")
        ...
        probability_label = EtoForms.Label(Text="Probability:")
        ...
        info_label = EtoForms.Label(Text=description_text)
        if hasattr(info_label, 'Wrap'):
            info_label.Wrap = EtoForms.WrapMode.Word
    ...
    def CreateShapeFinderTab(self):
        ...
        self.sf_small_angle.DecimalPlaces = 1
        self.sf_small_angle.MinValue = 0
        self.sf_small_angle.MaxValue = 180
        self.sf_small_angle.Increment = 0.1
        self.sf_small_angle.Value = self.shapefinder_params.get("small_angle_deg", 3.0)
        gl.AddRow(EtoForms.Label(Text="Small angle (deg):"), self.sf_small_angle)

        # angle_tolerance_deg: tolerance used when merging/accepting angles (degrees)
        self.sf_angle_tolerance = EtoForms.NumericStepper()
        self.sf_angle_tolerance.DecimalPlaces = 1
        self.sf_angle_tolerance.MinValue = 0
        self.sf_angle_tolerance.MaxValue = 180
        self.sf_angle_tolerance.Increment = 0.1
        self.sf_angle_tolerance.Value = self.shapefinder_params.get("angle_tolerance_deg", 5.0)
        gl.AddRow(EtoForms.Label(Text="Angle tolerance (deg):"), self.sf_angle_tolerance)
    ...
    def CreatePCLTab(self):
        ...
        plane_distance_label = EtoForms.Label(Text="Distance Threshold:")
        ...
        normal_weight_label = EtoForms.Label(Text="Normal Distance Weight:")
        ...
        plane_iterations_label = EtoForms.Label(Text="Max Iterations:")
        ...
        cylinder_distance_label = EtoForms.Label(Text="Distance Threshold:")
        ...
        cylinder_normal_weight_label = EtoForms.Label(Text="Normal Distance Weight:")
        ...
        radius_min_label = EtoForms.Label(Text="Min Radius:")
        ...
        radius_max_label = EtoForms.Label(Text="Max Radius:")
        ...
        cylinder_iterations_label = EtoForms.Label(Text="Max Iterations:")
        cylinder_layout.AddRow(cylinder_iterations_label, self.pcl_cylinder_iterations_box)
        
        cylinder_group.Content = cylinder_layout
        
        # Add info
        info_label = EtoForms.Label(Text="PCL (Point Cloud Library) specific parameters for plane and cylinder detection using RANSAC.")
        if hasattr(info_label, 'Wrap'):
            info_label.Wrap = EtoForms.WrapMode.Word
    ...
    def UpdateParametersFromUI(self):
        ...
        # new angle tolerance parameter
        self.shapefinder_params["angle_tolerance_deg"] = float(self.sf_angle_tolerance.Value)
    ...
    def UpdateUIFromParameters(self):
        ...
        if hasattr(self, 'sf_parent_tol'):
            ...
            self.sf_angle_tolerance.Value = self.shapefinder_params.get("angle_tolerance_deg", self.shapefinder_params.get("angle_tolerance_deg", 5.0))
